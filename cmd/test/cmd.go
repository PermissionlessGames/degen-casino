...
import (
	...
	"github.com/PermissionlessGames/degen-casino/bindings/Tests/TestableDegenGambit"
...
func CreateRootCommand() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "test",
		Short: "test: The Testable Degen Casino CLI",
	...
	gambitCmd := TestableDegenGambit.CreateTestableDegenGambitCommand()
	gambitCmd.Use = "testable-gambit"
