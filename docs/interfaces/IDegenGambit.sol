...
interface IDegenGambit {
	...
	event DelegationApproved(address player, address delegate, uint256 timeApprovedFor);
	event DelegationRevoked(address player, address delegate);
	...
	// Selector: b586a56a
	function TimeApprovedFor(address , address ) external view returns (uint256);
	// Selector: bd0ebd4b
