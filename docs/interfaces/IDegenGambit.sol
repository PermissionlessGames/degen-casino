...
interface IDegenGambit {
	...
	// Selector: eca8b788
	function inspectOutcome(address degenerate) external view returns (uint256 left, uint256 center, uint256 right, uint256 remainingEntropy, uint256 prize, bool nativeToken);
	// Selector: 06fdde03
	...
	// Selector: b3dfa13d
	function payout(uint256 left, uint256 center, uint256 right) external view returns (uint256 result, bool nativeToken);
	// Selector: 11cceaf6
	function prizes() external view returns (uint256[6] memory prizesAmount, string[6] memory typeOfPrize);
	// Selector: 82e82634
